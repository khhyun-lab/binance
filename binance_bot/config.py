...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        min_take_profit_on_margin_pct=_to_decimal(os.getenv("BINANCE_FUTURES_MIN_TAKE_PROFIT_ON_MARGIN_PCT"), "0.030"),
        max_take_profit_on_margin_pct=_to_decimal(os.getenv("BINANCE_FUTURES_MAX_TAKE_PROFIT_ON_MARGIN_PCT"), "0.050"),
        min_stop_loss_on_margin_pct=_to_decimal(os.getenv("BINANCE_FUTURES_MIN_STOP_LOSS_ON_MARGIN_PCT"), "0.020"),
        max_stop_loss_on_margin_pct=_to_decimal(os.getenv("BINANCE_FUTURES_MAX_STOP_LOSS_ON_MARGIN_PCT"), "0.030"),
        ...
        short_max_take_profit_on_margin_pct=_to_decimal(os.getenv("BINANCE_FUTURES_SHORT_MAX_TAKE_PROFIT_ON_MARGIN_PCT", os.getenv("BINANCE_FUTURES_MAX_TAKE_PROFIT_ON_MARGIN_PCT")), "0.050"),
        short_min_stop_loss_on_margin_pct=_to_decimal(os.getenv("BINANCE_FUTURES_SHORT_MIN_STOP_LOSS_ON_MARGIN_PCT", os.getenv("BINANCE_FUTURES_MIN_STOP_LOSS_ON_MARGIN_PCT")), "0.020"),
